...
namespace adata
{
    ...
    public class AdataWriter : IDisposable
    {
        internal UType Value = new UType();

        public BinaryWriter Stream { get; private set; }

        public AdataWriter(System.IO.Stream s)
        {
    ...
    public class ZeroCopyBuffer
    {
        ...
        public bool End { get { return read_len >= data_len; } }
    ...
    public class Stream
    {
        ...
        public static void FixWrite(AdataWriter stream, sbyte value)
        {
            stream.Stream.Write((byte)value);
        }

        public static void FixWrite(AdataWriter stream, byte value)
        {
            stream.Stream.Write((byte)value);
        }

        public static void FixWrite(AdataWriter stream, Int16 value)
        {
            UType val = stream.Value;
            val.VI16 = value;
            if (IsLittleEndian)
            {
                stream.Stream.Write(val.Byte0);
                stream.Stream.Write(val.Byte1);
            }
            else
            {
                stream.Stream.Write(val.Byte1);
        ...
        public static void FixWrite(AdataWriter stream, UInt16 value)
        {
            UType val = stream.Value;
            val.VU16 = value;
            if (IsLittleEndian)
        ...
        public static void FixWrite(AdataWriter stream, Int32 value)
        {
            UType val = stream.Value;
            val.VI32 = value;
            if (IsLittleEndian)
            {
                stream.Stream.Write(val.Byte0);
                stream.Stream.Write(val.Byte1);
                stream.Stream.Write(val.Byte2);
                stream.Stream.Write(val.Byte3);
            }
            else
            {
                stream.Stream.Write(val.Byte3);
        ...
        public static void FixWrite(AdataWriter stream, UInt32 value)
        {
            UType val = stream.Value;
            val.VU32 = value;
            if (IsLittleEndian)
        ...
        public static void FixWrite(AdataWriter stream, Int64 value)
        {
            UType val = stream.Value;
            val.VI64 = value;
            if (IsLittleEndian)
            {
                ...
                stream.Stream.Write(val.Byte2);
                stream.Stream.Write(val.Byte3);
                stream.Stream.Write(val.Byte4);
                stream.Stream.Write(val.Byte5);
                stream.Stream.Write(val.Byte6);
                stream.Stream.Write(val.Byte7);
            }
            else
            {
                stream.Stream.Write(val.Byte7);
        ...
        public static void FixWrite(AdataWriter stream, UInt64 value)
        {
            UType val = stream.Value;
            val.VU64 = value;
            if (IsLittleEndian)
        ...
        public static void Write(AdataWriter stream, float value)
        {
            UType val = stream.Value;
            val.VF32 = value;
            if (IsLittleEndian)
        ...
        public static void Write(AdataWriter stream, double value)
        {
            UType val = stream.Value;
            val.VF64 = value;
            if (IsLittleEndian)
        ...
        public static void Write(AdataWriter stream, sbyte value)
        {
            if (0 <= value && value <= const_tag_as_value)
            {
                stream.Stream.Write((byte)value);
            ...
            else
            {
                ...
                stream.Stream.Write(tag);
                stream.Stream.Write(temp);
            }
        }

        public static void Write(AdataWriter stream, byte value)
        {
            if (value <= const_tag_as_value)
            {
                stream.Stream.Write((byte)value);
        ...
        public static void Write(AdataWriter stream, Int16 value)
        {
            if (0 <= value && value <= const_tag_as_value)
            {
                stream.Stream.Write((byte)value);
            ...
            else
            {
                ...
                else
                {
                    ...
                    if (IsLittleEndian)
                    {
                        stream.Stream.Write(stream.Value.Byte0);
                        stream.Stream.Write(stream.Value.Byte1);
                    }
                    else
                    {
                        stream.Stream.Write(stream.Value.Byte1);
        ...
        public static void Write(AdataWriter stream, UInt16 value)
        {
            if (value <= const_tag_as_value)
            {
                stream.Stream.Write((byte)value);
            ...
            else
            {
                if (value < 0x100)
                {
                    stream.Stream.Write((byte)(0x80));
                    stream.Stream.Write((byte)value);
                }
                else
                {
                    stream.Value.VU16 = value;
                    stream.Stream.Write((byte)(0x81));
                    if (IsLittleEndian)
                    {
                        stream.Stream.Write(stream.Value.Byte0);
                        stream.Stream.Write(stream.Value.Byte1);
        ...
        public static void Write(AdataWriter stream, Int32 value)
        {
            if (0 <= value && value <= const_tag_as_value)
            {
                stream.Stream.Write((byte)value);
            ...
            else
            {
                ...
                else if (temp < 0x10000)
                {
                    ...
                    {
                        stream.Stream.Write(stream.Value.Byte3);
                        stream.Stream.Write(stream.Value.Byte2);
                    }
                }
                else if (temp < 0x1000000)
                {
        ...
        public static void Write(AdataWriter stream, UInt32 value)
        {
            if (value <= const_tag_as_value)
            {
                stream.Stream.Write((byte)value);
        ...
        public static void Write(AdataWriter stream, Int64 value)
        {
            if (0 <= value && value <= const_tag_as_value)
            {
                stream.Stream.Write((byte)value);
            ...
            else
            {
                ...
                else if (temp < 0x10000)
                {
                    ...
                    {
                        stream.Stream.Write(stream.Value.Byte7);
                        stream.Stream.Write(stream.Value.Byte6);
                    }
                }
                else if (temp < 0x1000000)
                {
                    ...
                    else
                    {
                        stream.Stream.Write(stream.Value.Byte7);
                        stream.Stream.Write(stream.Value.Byte6);
                        stream.Stream.Write(stream.Value.Byte5);
                    }
                }
                else if (temp < 0x100000000L)
                {
                    ...
                    else
                    {
                        ...
                        stream.Stream.Write(stream.Value.Byte6);
                        stream.Stream.Write(stream.Value.Byte5);
                        stream.Stream.Write(stream.Value.Byte4);
                    }
                }
                else if (temp < 0x10000000000L)
                {
        ...
        public static void Write(AdataWriter stream, UInt64 value)
        {
            if (value <= const_tag_as_value)
            {
                stream.Stream.Write((byte)value);
        ...
        public static void Write(AdataWriter stream, string value, Int32 len)
        {
            byte[] buff = Encoding.UTF8.GetBytes(value);
            if (buff.Length > len)
            {
                throw new ADataException(EErrorCode.sequence_length_overflow);
            }
            stream.Stream.Write(buff);
        }

        public static void Write(AdataWriter stream, byte[] buff, Int32 len)
        {
            stream.Stream.Write(buff, 0, len);
        }

        public static void Write(AdataWriter stream, string value)
        {
            byte[] buff = Encoding.UTF8.GetBytes(value);
        ...
        public static void Write(AdataWriter stream, byte[] buff)
        {
            Int32 len = buff.Length;
            Write(stream, len);
            stream.Stream.Write(buff);
